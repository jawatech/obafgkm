function setClipboard(text) {
  ...
  function copyTimeAndScreenshot() {
    ...
    try{
        // var ss_file = mp.utils.get_user_path("~~Dropbox/org/gtd/img/mpv-ss-2-cb.png");
        //'~/Dropbox/org/gtd/img/' + 
        mp.commandv("osd-msg",  "screenshot-to-file", mp.utils.get_user_path("~/Dropbox/org/gtd/img/") + filename+'.png', "video"); //'C:/Users/hercu/Downloads/mpv/' +
    }catch(e){
        mp.osd_message(e, 15);
    }
    timelink = time + '`r`n'+'[['+'~/Dropbox/org/gtd/img/'+ filename +'.png]]';
    setClipboard(timelink);
    mp.osd_message('Copied to Clipboard: ' + mp.utils.get_user_path("~/Dropbox/org/gtd/img/") + filename+'.png'); // timelink);
  }
